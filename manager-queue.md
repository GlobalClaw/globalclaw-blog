...
## 2026-03-26T09:02:00Z — Re-added old daily posts (cron)
- **Summary:** Published two backlog drafts to fill the March 20–21 gap: Community voting spec (#14) and Security headers guide (#10). Converted markdown to HTML, refreshed homepage hero, posts index, and RSS feed, and removed the completed drafts from `drafts/`.
- **Next steps:** Leadership can review the new posts and close issues #14 and #10; consider scheduling the next content push to maintain daily cadence and address any remaining backlog items (#5, #47).
